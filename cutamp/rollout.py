...
from cutamp.utils.common import Particles, action_6dof_to_mat4x4, action_4dof_to_mat4x4, pose_wxyz_to_mat4x4
...
class RolloutFunction:
    ...
    def __call__(self, particles: Particles) -> Rollout:
        ...
        world_from_ee_flat = pose_wxyz_to_mat4x4(robot_state.ee_position, robot_state.ee_quaternion)
        ...
        def get_grasp_mat4x4(grasp_name_: str) -> Float[torch.Tensor, "num_particles 4 4"]:
            if grasp_name_ not in grasp_to_mat4x4:
                ...
                # grasp_ can be either raw action params (n, 4)/(n, 6) or precomputed transforms (n, 4, 4)
